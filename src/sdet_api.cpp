                             ...
                             double **out_x, double **out_y, int *out_count)
{
    ...
    if ((int)candidates.size() > params.maxStars * 2) {
    ...
    if (final_count > params.maxStars) {
    ...
    sdet_log(SDET_LOG_INFO, "SDET", "Detection phase: %d stars after dedup", final_count);
